...
async def parse_all_sellers():
    ...
    if cookies:
        ...
        logger.info("ℹ️ Cookies не указаны в .env - парсер попытается получить их автоматически")
        logger.info("💡 Если автоматическое получение не сработает, добавьте cookies в .env:")
